    ...
    <section class="rounded-2xl border border-stone-200 bg-white p-6 shadow-sm sm:p-8">
        ...
        <div class="mt-6 grid gap-5 sm:grid-cols-2">
            ...
            <label class="block sm:col-span-2">
                ...
                <input wire:model="creators" type="text" placeholder="Autorinnen, Autoren oder Körperschaften" class="mt-2 w-full rounded-lg border border-stone-300 px-3 py-2">
            ...
            <label class="block">
                ...
                <input wire:model="isbn" type="text" class="mt-2 w-full rounded-lg border border-stone-300 px-3 py-2">
