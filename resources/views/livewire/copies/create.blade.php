<form wire:submit="save" class="rounded-2xl border border-stone-200 bg-white p-6 shadow-sm">
    <h2 class="text-xl font-semibold">Exemplar anlegen</h2>
    <p class="mt-1 text-sm text-stone-500">
        Besitz, Standort und Zustandsdaten für ein physisches Exemplar erfassen.
    </p>
    ...
    <div class="mt-5 grid gap-5 sm:grid-cols-2">
        ...
        <label class="block">
            ...
            @error('acquiredAt') <span class="mt-1 block text-sm text-red-700">{{ $message }}</span> @enderror
        </label>
        ...
        <label class="block">
            ...
            @error('acquisitionSource') <span class="mt-1 block text-sm text-red-700">{{ $message }}</span> @enderror
        </label>
        ...
        <label class="block">
            ...
            @error('purchasePrice') <span class="mt-1 block text-sm text-red-700">{{ $message }}</span> @enderror
        </label>

        <label class="block sm:col-span-2">
            <span class="text-sm font-medium">Notiz zum Exemplar</span>
